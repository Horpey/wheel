...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="header clearfix" >
                <nav>
                    <ul class="nav nav-pills float-xs-right">
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Wheel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo IRIKI_URL ?>app/wheel">Matrix</a>
                        </li>
                    </ul>
                </nav>
            ...
            <footer class="footer">
                <p><a href="https://github.com/stigwue/iriki/archive/master.zip">Iriki</a> &copy; 2016 - <?php echo date("Y"); ?> Eyeti Ltd.</a></p>
            </footer>
